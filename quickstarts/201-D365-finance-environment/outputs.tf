...
output "url" {
  ...
  value       = powerplatform_environment.xpp-dev1.dataverse.url
}

output "linked_app_type" {
  description = "Type of the linked D365 app"
  value       = powerplatform_environment.xpp-dev1.dataverse.linked_app_type
}

output "linked_app_id" {
  description = "Unique identifier of the linked D365 Finance app"
  value       = powerplatform_environment.xpp-dev1.dataverse.linked_app_id
}

output "linked_app_url" {
  description = "URL of the linked D365 Finance app"
  value       = powerplatform_environment.xpp-dev1.dataverse.linked_app_url
}
